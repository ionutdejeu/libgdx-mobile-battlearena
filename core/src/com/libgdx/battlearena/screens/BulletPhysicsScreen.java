...
public class BulletPhysicsScreen implements Screen {
    ...
    class MyContactListener extends ContactListener {
        ...
        public boolean onContactAdded (btManifoldPoint cp, btCollisionObjectWrapper colObj0Wrap, int partId0, int index0,
            ...
            ((GameObject)instances.get(colObj0Wrap.getCollisionObject().getUserValue())).moving = false;
            ((GameObject)instances.get(colObj1Wrap.getCollisionObject().getUserValue())).moving = false;
            return true;
        }
    }
    ...
    public BulletPhysicsScreen(Game g) {
