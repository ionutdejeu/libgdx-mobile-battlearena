...
public class ktCharacterControllerTest implements Screen {
    ...
    public ktCharacterControllerTest(Game g) {
    ...
    public void render(float delta) {
        ...
        float d = Math.min(1f / 30f, Gdx.graphics.getDeltaTime());

        angle = (angle + d * speed) % 360f;
