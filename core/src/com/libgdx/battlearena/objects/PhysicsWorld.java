...
public class PhysicsWorld extends BaseWorld<RigidBodyEntity> {
    ...
    public PhysicsWorld (final btCollisionConfiguration collisionConfiguration, final btCollisionDispatcher dispatcher,
    ...
    public PhysicsWorld (final Vector3 gravity) {
    ...
    @Override
    public void add (final RigidBodyEntity entity) {
        super.add(entity);
        if (entity.body != null) {
    ...
    @Override
    public void render (ModelBatch batch, Environment lights, Iterable<RigidBodyEntity> entities) {
